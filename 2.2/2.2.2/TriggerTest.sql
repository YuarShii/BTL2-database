...
INSERT INTO CHI_TIET_GIOHANG (maGioHang, maSanPham, soLuongGio, giaLucThemGio) VALUES (5, 99, 2, 50000);
SELECT maGioHang, tongTienGioHang FROM GIOHANG WHERE maGioHang = 5;

-- B2. Khách sửa số lượng lên 5 áo
-- Kỳ vọng: Tổng tiền = 250.000 (5 * 50k)
UPDATE CHI_TIET_GIOHANG SET soLuongGio = 5 WHERE maGioHang = 5 AND maSanPham = 99;
SELECT maGioHang, tongTienGioHang FROM GIOHANG WHERE maGioHang = 5;
